...
(function (Chat) {
    function chatToPlainString(chat) {
        ...
        if (chat.extra != null) {
            chat.extra.forEach(extra => {
                ...
                if (extra.color)
                    append += extra.color == 'reset' ? Enums.ChatColor.RESET : resolveColor(extra.color);
                append += extra.text;
                ret += append;
            });
        }
    ...
    function resolveColor(colorStr) {
        var _a;
        return (_a = Object.values(Enums.ChatColor)[ccKeys.indexOf(colorStr.toLowerCase())]) !== null && _a !== void 0 ? _a : colorStr;
    }
})(Chat || (Chat = {}));
