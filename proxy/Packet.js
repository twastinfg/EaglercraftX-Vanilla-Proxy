...
export async function loadPackets(dir) {
    const files = (await Util.recursiveFileSearch(dir !== null && dir !== void 0 ? dir : join(dirname(fileURLToPath(import.meta.url)), "packets"))).filter(f => f.endsWith(".js") && !f.endsWith(".disabled.js"));
